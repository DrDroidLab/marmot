# Marmot from the terminal

Everything the Mac app does is also a command. The app ships this CLI inside
it, and a Homebrew install links it as `marmot`, so if you installed the app
with `brew` you already have it. Without the app, or from a DMG install:
...
<p align="center">
  <img src="nudge-context.png" alt="Marmot notification recommending compacting or starting a new session because each turn is re-sending 140K tokens of history" width="720">
</p>
